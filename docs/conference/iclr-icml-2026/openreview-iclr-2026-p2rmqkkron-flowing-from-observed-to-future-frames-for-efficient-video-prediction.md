...
score: 8.0
evidence: 学习观测帧与未来帧分布间的向量场
tldr: 视频预测需要在高效前提下建模观测帧与未来帧之间的分布关系。本文微调预训练文生视频流模型，直接学习观测帧分布到未来帧分布的向量场，并采用连续视频块作为固有最优耦合的近似，同时引入目标反转以增强对应关系。实验表明该方法产生更直的流并提升视觉保真度，实现快速且省内存的视频预测。其贡献在于直接建模帧间分布关系而非简单加噪生成。
source: ICLR-2026-Public
selection_source: conference_retrieval
motivation: 视频预测需在高效前提下建模观测帧与未来帧的关系。
method: 微调文生视频流模型，学习观测帧到未来帧分布间的向量场，采用固有最优耦合与目标反转。
result: 直接由观测帧流向未来帧，得到更直的流并提升视觉保真度。
conclusion: 为高效视频预测提供直接建模帧分布关系的方案。
---
