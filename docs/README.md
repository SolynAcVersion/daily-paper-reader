...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-12 21:34:44 UTC<br>状态：成功</p>
</section>
...
<p>今日精读3篇，聚焦视频生成物理评测与微短剧理解基准。最值得看的是9.0分的《PhysWeep》追问视频生成器是否真懂物理，以及8.0分微短剧结构感知图对齐基准。普通读者可优先读这两篇，留意模型物理短板和微短剧理解的数据与对齐方法。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="PhysWeep: Does a Video Generator Realize the Physics You Ask For?">PhysWeep: Does a Video Generator Realize the Physics You Ask For?</span></li><li><span class="dpr-home-dashboard-paper-title" title="Beyond Sparse Rewards: A New Benchmark and Structure-Aware Graph Alignment for Micro-Drama Understanding">Beyond Sparse Rewards: A New Benchmark and Structure-Aware Graph Alignment for Micro-Drama Understanding</span></li><li><span class="dpr-home-dashboard-paper-title" title="PhysReal: Learning Real-World Deformable Object Physics via Hybrid Constitutive Modeling">PhysReal: Learning Real-World Deformable Object Physics via Hybrid Constitutive Modeling</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">phys-video <strong>2</strong></span><span class="dpr-home-dashboard-tag">manga-drama <strong>1</strong></span></div>
</section>
