...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-06 22:24:13 UTC<br>状态：成功</p>
</section>
...
<p>今日精读聚焦AI视频生成：5篇推荐中，多智能体框架与短剧生成基准两篇获8分高分。最值得关注方向是AI视频生产的动态协作框架（FRAMEWORKERS）与短剧评测体系（DramaChain Bench）。若想跟上热点，可优先精读这两篇8分论文，速读部分仅供拓宽视野。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="FRAMEWORKERS: A Dynamic Multi-Agent Framework for AI-Generated Video Production">FRAMEWORKERS: A Dynamic Multi-Agent Framework for AI-Generated Video Production</span></li><li><span class="dpr-home-dashboard-paper-title" title="DramaChain Bench: An End-to-End Benchmark for Short-Drama Generation">DramaChain Bench: An End-to-End Benchmark for Short-Drama Generation</span></li><li><span class="dpr-home-dashboard-paper-title" title="Do Video Generators Track the World Across Segments? A Benchmark and Method for World-State Reasoning in Video Continuation">Do Video Generators Track the World Across Segments? A Benchmark and Method for World-State Reasoning in Video Continuation</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">manga-drama <strong>2</strong></span><span class="dpr-home-dashboard-tag">phys-video <strong>1</strong></span></div>
</section>
